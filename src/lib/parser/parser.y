...
%token SEMICOLON OPEN_BRACKET CLOSE_BRACKET PLUS_PLUS MINUS_MINUS OPEN_PAREN CLOSE_PAREN
%token IF ELSE WHILE FOR RETURN OPEN_CURLY_BRACKET CLOSE_CURLY_BRACKET
%token EQUAL_OPERATOR COMMA_OPERATOR EQUAL_EQUAL_OPERATOR NO_EQUAL_OPERATOR
%token LESS_THAN_OPERATOR NOT_MORE_THAN_OPERATOR MORE_THAN_OPERATOR NOT_LESS_THAN_OPERATOR
...
%token ADD_EQUAL_OPERATOR MINUS_EQUAL_OPERATOR MULTP_EQUAL_OPERATOR DIV_EQUAL_OPERATOR REM_EQUAL_OPERATOR
%token LEFT_SHIFT_EQUAL_OPERATOR RIGHT_SHIFT_EQUAL_OPERATOR AND_EQUAL_OPERATOR XOR_EQUAL_OPERATOR OR_EQUAL_OPERATOR
